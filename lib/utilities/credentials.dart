...
class UntisCredentials {
  ...
  /// Initializes a new Untis session with the provided credentials.
  /// Returns a [UntisSession] object that can be used to interact with the Untis API.
  Future<UntisSession> initSession() async {
    return await UntisSession.init(server, school, username, password);
  }

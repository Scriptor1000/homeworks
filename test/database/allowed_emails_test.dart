  ...
  group('AllowedUser Tests', () {
    ...
    test(
      ...
      () async {
        ...
        // test
        final isAllowed = await firestoreAllowedEmails.isEmailAllowed(
          validEmail,
        );
        // verify
    ...
    test(
      ...
      () async {
        // test
        final isNotAllowed = await firestoreAllowedEmails.isEmailAllowed(
          invalidEmail,
        );
        // verify
    ...
    test(
      'should replace temporary entries with document with uid as name',
      () async {
        // setup
        await mockFirestore
            .collection(FirestoreAllowedEmails.emailsCollection)
    ...
    test(
      'should create a document with uid and email to authorize an email',
      () async {
        // test
    ...
    test(
      'should delete the document with the uid to revoke an email',
      () async {
        // setup
        await mockFirestore
            .collection(FirestoreAllowedEmails.emailsCollection)
